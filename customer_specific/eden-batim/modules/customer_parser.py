...
class ExcelRecord(object):
    ...
    def monthlyData(self, year, excelCellInfoPerDate = None):
        ...
        for month in allMonths:                                    
            ...
            actual_payment = 0 if self.monthlyPayment(month) == "" else expected_payment
    ...
    @property
    def owner(self):
        return excel_utils.ExtractCellValueByColumn(self, 'שם')
    ...
    def ownerPhones(self):  
        phones = excel_utils.ExtractCellValueByColumn(self, 'טלפון')
        try:
            return phones.split()
